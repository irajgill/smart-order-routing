...
contract SORFactoryTest is Test {
    ...
    function testCreateRouter() public {
        ...
        address router = factory.createRouter{ value: CREATION_FEE }(
            address(priceOracle), user, "Test Router", "A test router for SOR"
        );
    ...
    function test_CreateRouterWithZeroOracle() public {
        ...
        try factory.createRouter{ value: CREATION_FEE }(address(0), user, "Test Router", "A test router for SOR")
    ...
    function testGetRoutersByCreator() public {
        ...
        address router1 =
            factory.createRouter{ value: CREATION_FEE }(address(priceOracle), user, "Router 1", "First test router");

        address router2 =
            factory.createRouter{ value: CREATION_FEE }(address(priceOracle), user, "Router 2", "Second test router");
    ...
    function testPauseUnpause() public {
        ...
        // Fix: Add all 4 required parameters
        factory.createRouter{ value: CREATION_FEE }(address(priceOracle), user, "Test Router", "A test router for SOR");
