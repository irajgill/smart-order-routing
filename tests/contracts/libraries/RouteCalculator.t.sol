...
contract RouteCalculatorTest is Test {
    ...
    function testCalculateOutputAmount() public pure {
        ...
        uint256 output = RouteCalculator.calculateOutputAmount(
            amountIn,
            reserveIn,
            reserveOut,
            fee
    ...
    function testCalculateRouteScore() public pure {
        ...
        uint256 score = RouteCalculator.calculateRouteScore(
            expectedOutput,
            priceImpact,
            gasEstimate
        );
    ...
    function testFindBestSplitPercentages() public pure {
        ...
        uint256[] memory percentages = RouteCalculator.findBestSplitPercentages(
            routeOutputs,
            routeGasEstimates,
            totalAmount
        );
